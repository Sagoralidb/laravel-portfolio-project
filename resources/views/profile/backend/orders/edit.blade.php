        ...
        <div class="card">          
            <div class="card-body table-responsive p-0">	
                <div class=" container card mb-4">
                    <div class="row">
                      <span class="btn btn-primary text-light text-center">
                        <i class="fa-solid fa-plus text-light"></i> Create New Order</span>
                    </div>  
                    <form action="{{route('customerOrder.store')}}" method="post" id="orderForm">
                      @csrf
                      @method('POST')
                          ...
                          <div class="col-sm-9"> 
                            <select name="user_id" id="user_id" class="form-control select2" style="width: 20%">
                                <option value="" disabled>Select User</option>
                                    <option {{ $orderEdit->user_id ? 'selected': ''}} value="{{  $orderEdit->user_id}}"> {{  $orderEdit->user_id }}</option>  
                            </select>
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-sm-9"> 
                            <input type="text" name="title" id="title" value="{{$orderEdit->title?:''}}" class="form-control" placeholder="">
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-sm-9"> 
                            <textarea name="description" id="description" cols="30" rows="5" class="summernote form-control" 
                            placeholder="Description">{{$orderEdit->description ?: ''}}</textarea>
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-sm-9"> 
                              <input type="text" name="budget" id="budget" value="{{$orderEdit->title?:''}}" class="form-control" placeholder="">
                              <p id="titleError" class="text-danger"></p>
                            </div>
                          </div>
                          <hr class="mt-2">
...
@endsection
    ...
    <script>
        $("#orderForm").submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('update.order',$orderEdit->id) }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
